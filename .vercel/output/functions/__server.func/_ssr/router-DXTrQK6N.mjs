...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Structured, practical learning in Tarot, Numerology and Energy Healing with Manisha. Life doesn’t always move in a straight line."
			},
			{
				name: "theme-color",
				content: "#0b1016"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Outfit:wght@300;400;500;600&family=La+Belle+Aurore&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
